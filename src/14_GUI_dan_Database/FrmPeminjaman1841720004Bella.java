...
import bella.guidbs.backend.Anggota1841720004Bella;
import bella.guidbs.backend.Buku1841720004Bella;
import bella.guidbs.backend.DBHelper1841720004Bella;
import bella.guidbs.backend.Peminjaman1841720004Bella;
 ...
 * @author bella
 */
public class FrmPeminjaman1841720004Bella extends javax.swing.JFrame {

    /**
     * Creates new form FrmPeminjaman
     */
    public FrmPeminjaman1841720004Bella() {
        initComponents();
        tampilkanDataBella();
        kosongkanFormBella();
    }
    ...
    public void tampilkanDataBella(){
        String[] kolom = {"ID Peminjaman", "ID Angota", "ID Buku", "Tanggal Pinjam", "Tanggal Kembali"};
        ArrayList<Peminjaman1841720004Bella> list = new Peminjaman1841720004Bella().getAllBella();
        Object rowData[] = new Object[5];
        
        tblPeminjaman.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(int i = 0; i < list.size(); i++){
            rowData[0] = list.get(i).getmIdPeminjamanBella();
            rowData[1] = list.get(i).getmAnggotaBella().getmIdAnggotaBella();
            rowData[2] = list.get(i).getmBukuBella().getmIdBukuBella();
            rowData[3] = list.get(i).getmTanggalPinjamBella();
            rowData[4] = list.get(i).getmTanggalKembaliBella();
    ...
    private void initComponents() {
        ...
        pinjam.setText("Format: YYYY/MM/DD");

        kembali.setText("Format: YYYY/MM/DD");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(txtIdAnggota, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        .addComponent(txtIdBuku, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(btnCariBuku))
                                    .addComponent(txtTanggalKembali))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(anggota, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnCariBukuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariBukuActionPerformed
        ...
        pem.cariBukuBella(Integer.parseInt(this.txtIdBuku.getText()));
        this.buku.setText((pem.getmBukuBella().getMjudulBella()));
    }//GEN-LAST:event_btnCariBukuActionPerformed

    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        // TODO add your handling code here:
        Peminjaman1841720004Bella pem = new Peminjaman1841720004Bella();
        pem.setmIdPeminjamanBella(Integer.parseInt(txtId.getText()));
        pem.setmAnggotaBella(new Anggota1841720004Bella().getByIdBella(Integer.parseInt(txtIdAnggota.getText())));
        pem.setmBukuBella(new Buku1841720004Bella().getByIdBella(Integer.parseInt(txtIdBuku.getText())));
        pem.setmTanggalPinjamBella(txtTanggalKembali.getText());
        pem.setmTanggalKembaliBella(txtTanggalKembali.getText());
        pem.saveBella();
        tampilkanDataBella();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Peminjaman1841720004Bella pem = new Peminjaman1841720004Bella().getByIdBella(Integer.parseInt(model.getValueAt(row, 0).toString()));
        pem.deleteBella();
        kosongkanFormBella();
        tampilkanDataBella();
    ...
    private void btnCariAnggotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariAnggotaActionPerformed
        // TODO add your handling code here:
        Peminjaman1841720004Bella pem = new Peminjaman1841720004Bella();
        pem.cariAnggotaBella(Integer.parseInt(this.txtIdAnggota.getText()));
        this.anggota.setText((pem.getmAnggotaBella().getmNamaBella()));
    ...
    private void tblPeminjamanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPeminjamanMouseClicked
        ...
        this.txtId.setText(String.valueOf(pem.getmIdPeminjamanBella()));
        this.txtIdAnggota.setText(String.valueOf(pem.getmAnggotaBella().getmIdAnggotaBella()));
        this.txtIdBuku.setText(String.valueOf(pem.getmBukuBella().getmIdBukuBella()));
        this.txtTanggalPinjam.setText(String.valueOf(pem.getmTanggalPinjamBella()));
        this.txtTanggalKembali.setText(String.valueOf(pem.getmTanggalKembaliBella()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPeminjaman1841720004Bella.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPeminjaman1841720004Bella().setVisible(true);
            }
        });
    }
